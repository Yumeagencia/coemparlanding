          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="mt-6 flex flex-col items-center gap-4">
              <div className="flex flex-wrap justify-center gap-4">
                ...
                >
                  Probar Guía de Emprendimiento
                </button>
                <a
                  href="https://docs.google.com/spreadsheets/d/1MoIyAhLzWRq9SDjN84cMYB0nq2O6yYh-pQHzltKpyYw/edit?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 inline-block"
                >
                  Probar Lista de Proveedores
                </a>
              </div>
              <button
      ...
      <section id="modules-section" className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              6 Módulos educativos y una lista de proveedores y contactos de valor pensados estratégicamente para llevarte desde la idea inicial hasta un negocio próspero y escalable en Paraguay.
            </p>
          </div>
